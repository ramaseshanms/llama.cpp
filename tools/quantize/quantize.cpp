...
static const std::vector<quant_option> QUANT_OPTIONS = {
    ...
    { "Q4_HQQ",     LLAMA_FTYPE_MOSTLY_Q4_HQQ,     "HQQ 4-bit g32  — 5.00 bpw (KV-cache recommended)", },
    { "Q4_HQQ_128", LLAMA_FTYPE_MOSTLY_Q4_HQQ_128, "HQQ 4-bit g128 — 4.25 bpw (paper default, weight matrices)", },
