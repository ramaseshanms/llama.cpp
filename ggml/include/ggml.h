...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q4_HQQ      = 40, // HQQ 4-bit g32  (5.0 bpw)
        GGML_TYPE_Q4_HQQ_128  = 41, // HQQ 4-bit g128 (4.25 bpw, paper default)
        GGML_TYPE_COUNT       = 42,
    };
    ...
    enum ggml_ftype {
        ...
        GGML_FTYPE_MOSTLY_Q4_HQQ      = 26, // except 1d tensors — HQQ g32
        GGML_FTYPE_MOSTLY_Q4_HQQ_128  = 27, // except 1d tensors — HQQ g128
    };
